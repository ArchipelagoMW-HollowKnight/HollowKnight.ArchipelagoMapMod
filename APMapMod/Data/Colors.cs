...
namespace APMapMod.Data
{
    ...
    internal class Colors
    {
        ...
        public static void LoadCustomColors()
        {
            ...
            {
                APMapMod.Instance.LogError("Invalid colors.json file. Using default colors");
                return;
            }
            ...
            if (customColorsRaw != null)
            {
                ...
                APMapMod.Instance.Log("Custom colors loaded");
            }
            else
            {
                APMapMod.Instance.Log("No colors.json found. Using default colors");
            }
        }
